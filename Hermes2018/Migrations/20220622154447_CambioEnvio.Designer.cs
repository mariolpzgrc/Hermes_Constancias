...
namespace Hermes2018.Migrations
{
    ...
    [Migration("20220622154447_CambioEnvio")]
    partial class CambioEnvio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hermes2018.Models.Area.HER_Area", b =>
                {
                    ...
                    b.Property<bool>("HER_BajaInactividad");
            ...
            modelBuilder.Entity("Hermes2018.Models.Bitacora.HER_Bitacora", b =>
                {
                    b.Property<int>("HER_BitacoraId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("HER_Ip");

                    b.Property<string>("HER_NombreUsuario");

                    b.Property<string>("HER_Operacion");

                    b.Property<string>("HER_UserName");

                    b.HasKey("HER_BitacoraId");

                    b.HasIndex("HER_InfoUsuarioId");

                    b.ToTable("HER_Bitacora");
                });
